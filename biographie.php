...
<br/><br/>
<article>
	<img src="images/page3-img4.png" alt="" id="logoBio">
	<?php 
	...
	$data=mysql_fetch_array (mysql_query("SELECT * FROM  article WHERE id = 4")); 
	...
	echo utf8_encode ($data['titre']);  
	echo '<p id ="textBio">'.utf8_encode ($data['texte']).'</p>';
